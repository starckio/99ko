...
class core{
    ...
    public function __construct($forceLang = ''){
        ...
        // JS / CSS
        $this->js['public'] = explode(',', COMMON_JS);
        $this->js['admin'] = $this->js['public'];
        $this->js['public'][] = $this->getConfigVal('siteUrl').'/theme/'.$this->getConfigVal('theme').'/scripts.js';
        $this->js['admin'][] = $this->getConfigVal('siteUrl').'/admin/scripts.js';
        $this->css['public'] = explode(',', COMMON_CSS);
        $this->css['admin'] = $this->css['public'];
        $this->css['public'][] = $this->getConfigVal('siteUrl').'/theme/'.$this->getConfigVal('theme').'/styles.css';
        $this->css['admin'][] = $this->getConfigVal('siteUrl').'/admin/styles.css';
    }
