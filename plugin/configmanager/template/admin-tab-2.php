...
<p>
  ...
  <p>
      <input id="htaccessOptimization" type="checkbox" onclick="updateHtaccess('<?php echo $rewriteBase; ?>');" <?php if($core->getConfigVal('htaccessOptimization')){ ?>checked<?php } ?> name="htaccessOptimization" /> <label for="htaccessOptimization"><?php echo $core->lang("Optimize .htaccess file"); ?></label>
</p>
  <p>
