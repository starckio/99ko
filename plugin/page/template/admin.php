...
<?php if($mode == 'list'){ ?>
<ul class="tabs_style">
  <li><a class="btn" href="index.php?p=page&amp;action=edit">Ajouter une page</a></li>
  <li><a class="btn" href="index.php?p=page&amp;action=edit&parent=1">Ajouter un item parent</a></li>
  <li><a class="btn" href="index.php?p=page&amp;action=edit&link=1">Ajouter un lien externe</a></li>
</ul>
<table>
  <thead>
	<tr>
